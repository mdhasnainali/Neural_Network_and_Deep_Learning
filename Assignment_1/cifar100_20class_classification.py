...
from keras.applications import (
    ...
    DenseNet121, DenseNet201, NASNetMobile,
...
from keras.applications import (
    ...
    densenet, nasnet, efficientnet, efficientnet_v2, convnext
)
...
activation_functions = ['softmax', 'sigmoid', 'relu', 'tanh', 'linear', 'gelu', 'celu', 'elu', 'glu', 'silu']
...
def train_and_evaluate(model_name, train_ds, test_ds):
    ...
    model, preprocessing_input = build_model(model_name)
    ...
    train_history = model.fit(train_ds_x, train_ds_y, epochs=1, validation_split = 0.1)
...
if __name__ == "__main__":
    ...
    for model_name in models_dict.keys():
        evaluation_data = train_and_evaluate(model_name, train_ds, test_ds)
